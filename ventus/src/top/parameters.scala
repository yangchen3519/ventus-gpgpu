...
object parameters { //notice log2Ceil(4) returns 2.that is ,n is the total num, not the last idx.
  ...
  // This is a capacity slot, not the SRAM access bank used by L1D/SMEM datapaths.
  def unified_l1_partition_slot_bytes = sharedmem_BlockWords * BytesOfWord
  def dcache_NSets_default = dcache_NSets
  def dcache_NSets_max = 512
  def unified_l1_partition_slots =
    sharedmem_depth + dcache_NSets_default * dcache_NWays
  def unified_l1_min_l1d_slots = 64
  def unified_l1_min_smem_slots = 64
  def unified_l1_l1d_slot_granularity = dcache_NWays
  ...
  object CTA_SCHE_CONFIG {
    ...
    object GPU {
      ...
      val UNIFIED_L1_PARTITION_SLOT_BYTES = unified_l1_partition_slot_bytes
      val UNIFIED_L1_PARTITION_SLOTS = unified_l1_partition_slots
      val UNIFIED_L1_MIN_L1D_SLOTS = unified_l1_min_l1d_slots
      val UNIFIED_L1_MIN_SMEM_SLOTS = unified_l1_min_smem_slots
      val UNIFIED_L1_DEFAULT_SMEM_SLOTS =
        unified_l1_partition_slots - unified_l1_min_l1d_slots
    }
    object KERNEL {
