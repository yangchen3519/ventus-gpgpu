...
public:
    ...
    uint32_t get_lds_slot_count_per_wg() const { return m_metadata.ldsSlotCountPerWg; }
    uint32_t get_smem_slot_count_per_sm() const { return m_metadata.smemSlotCountPerSm; }
